...
mod tests {
    ...
    async fn create_twice_should_fail() {
        ...
        store
            .create(KEY_1, ValueEncoding::Ciborium, HELLO_WORLD)
            .await
            .unwrap();
    ...
    async fn conditional_put_should_work() {
        ...
        store
            .put_if_tag_matches(KEY_1, tag, ValueEncoding::Ciborium, WORLD)
            .await
            .unwrap();
    ...
    async fn conditional_put_should_fail() {
        ...
        store
            .put_if_tag_matches(KEY_1, tag.clone(), ValueEncoding::Ciborium, HELLO)
            .await
            .unwrap();

        match store
            .put_if_tag_matches(KEY_1, tag.clone(), ValueEncoding::Ciborium, WORLD)
            .await
        {
