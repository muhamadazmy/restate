...
use restate_types::partition_table::{
    Partition, PartitionTable, ReplicationStrategy, TargetPartitionPlacementState,
};
    ...
    async fn schedule_partitions(
        ...
        for _ in 0..num_scheduling_rounds {
            ...
            for (_, partition) in target_partition_table.partitions() {
                let target_state = partition.placement.clone().into_target_state();
