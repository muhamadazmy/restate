...
impl LogletConfiguration {
    ...
    fn try_reconfiguring(
        ...
        let next_loglet_id = match self {
            Self::Local(_) => LogletId::new(log_id, last_segment_index.next()),
            #[cfg(any(test, feature = "memory-loglet"))]
            Self::Memory(_) => LogletId::new(log_id, last_segment_index.next()),
            #[cfg(feature = "replicated-loglet")]
            Self::Replicated(params) => params.loglet_id.next(),
        };
