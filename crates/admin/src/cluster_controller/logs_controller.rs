...
/// For ease of update from local loglet <-> replicated loglet. It
/// is better to use a single type of ID.
/// Usually Local and Memory loglets use random number but
/// instead we going to use the ReplicatedLogletId implementation.
        ...
        G: Fn() -> Option<NodeId>,
    {
        match self {
            ...
            LogState::Sealed {
                ...
                // self.try_provisioning(cluster_configuration, observed_cluster_state, log_builder, node_set_selector_hints)
