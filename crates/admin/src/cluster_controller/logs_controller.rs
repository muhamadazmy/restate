    ...
    fn on_event(
        ...
        match event {
            ...
            Event::NewLogs => {
                ...
                effects.push(Effect::FindLogsTails);
            }
            Event::SealSucceeded {
                log_id,
                segment_index,
...
pub struct LogsController {
    ...
    find_logs_tails_semaphore: Arc<Semaphore>,
}
...
impl LogsController {
    pub async fn init(
        ...
        Ok(Self {
            ...
            find_logs_tails_semaphore: Arc::new(Semaphore::new(1)),
        })
    }

    pub fn find_logs_tails(&mut self) {
        // none
        let Ok(permit) = self.find_logs_tails_semaphore.clone().try_acquire_owned() else {
    ...
    fn apply_effects(&mut self) {
        ...
        for effect in effects.drain(..) {
            match effect {
                ...
                Effect::FindLogsTails => {
                    self.find_logs_tails();
                }
            }
        }
