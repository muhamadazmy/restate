...
pub mod proto {
    ...
    mod pb_conversion {
        ...
        use restate_types::{
            ...
            journal_v2::{CombinatorType, NotificationId, NotificationsCombinator, SignalId},
        };

        impl From<CombinatorType> for super::CombinatorType {
            fn from(value: CombinatorType) -> Self {
                match value {
                    CombinatorType::Unknown => Self::CombinatorUnknown,
        ...
        impl From<super::CombinatorType> for CombinatorType {
            fn from(value: super::CombinatorType) -> Self {
                match value {
                    super::CombinatorType::CombinatorUnknown => Self::Unknown,
        ...
        impl From<NotificationsCombinator> for super::Future {
            fn from(value: NotificationsCombinator) -> Self {
                let NotificationsCombinator {
                    combinator,
                    nested,
                    notifications,
                } = value;
        ...
        impl TryFrom<super::Future> for NotificationsCombinator {
            ...
            fn try_from(value: super::Future) -> Result<Self, Self::Error> {
                ...
                let combinator_type: CombinatorType =
                    super::CombinatorType::try_from(combinator_type)
                        .map_err(|v| {
                            ConversionError::unexpected_enum_variant("combinator_type", v.0)
                        })?
                        .into();
                ...
                Ok(Self {
                    notifications,
                    nested: {
                        let mut result = Vec::with_capacity(nested_futures.len());
                        for fut in nested_futures {
                            result.push(fut.try_into()?);
                        }
                        result
                    },
...
mod dto {
    ...
    impl From<SuspensionMessageV6> for SuspensionMessage {
        fn from(value: SuspensionMessageV6) -> Self {
            let fut = Future {
                combinator_type: CombinatorType::CombinatorUnknown.into(),
