...
use restate_ingress_core::Ingress;
...
where
    T: TransportConnect,
{
    pub fn new(ingress: Ingress<T>, schema: Live<Schema>) -> Self {
    ...
    pub async fn run(
        ...
        // restate_ingress_core::Ingress::new(networking, partition_table, partition_routing, budget, opts)
