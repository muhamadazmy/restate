...
use crate::metric_definitions::{
    METADATA_SERVER_DELETE_DURATION, METADATA_SERVER_DELETE_TOTAL_ERROR,
    METADATA_SERVER_DELETE_TOTAL_SUCCESS, METADATA_SERVER_GET_DURATION,
    METADATA_SERVER_GET_TOTAL_ERROR, METADATA_SERVER_GET_TOTAL_SUCCESS,
    METADATA_SERVER_GET_VERSION_DURATION, METADATA_SERVER_GET_VERSION_TOTAL_ERROR,
    METADATA_SERVER_GET_VERSION_TOTAL_SUCCESS, METADATA_SERVER_PUT_DURATION,
    METADATA_SERVER_PUT_TOTAL_ERROR, METADATA_SERVER_PUT_TOTAL_SUCCESS,
};
use crate::{
...
impl MetadataServerSvc for MetadataStoreHandler {
    async fn get(&self, request: Request<GetRequest>) -> Result<Response<GetResponse>, Status> {
        metrics_helper!(
            @success=METADATA_SERVER_GET_TOTAL_SUCCESS,
            @error=METADATA_SERVER_GET_TOTAL_ERROR,
            @duration=METADATA_SERVER_GET_DURATION,
            {
    ...
    async fn get_version(
        ...
        metrics_helper!(
            @success=METADATA_SERVER_GET_VERSION_TOTAL_SUCCESS,
            @error=METADATA_SERVER_GET_VERSION_TOTAL_ERROR,
            @duration=METADATA_SERVER_GET_VERSION_DURATION,
            {
                let (result_tx, result_rx) = oneshot::channel();
    ...
    async fn put(&self, request: Request<PutRequest>) -> Result<Response<()>, Status> {
        metrics_helper!(
            @success=METADATA_SERVER_PUT_TOTAL_SUCCESS,
            @error=METADATA_SERVER_PUT_TOTAL_ERROR,
            @duration=METADATA_SERVER_PUT_DURATION,
            {
                let (result_tx, result_rx) = oneshot::channel();
    ...
    async fn delete(&self, request: Request<DeleteRequest>) -> Result<Response<()>, Status> {
        metrics_helper!(
            @success=METADATA_SERVER_DELETE_TOTAL_SUCCESS,
            @error=METADATA_SERVER_DELETE_TOTAL_ERROR,
            @duration=METADATA_SERVER_DELETE_DURATION,
            {
                let (result_tx, result_rx) = oneshot::channel();
