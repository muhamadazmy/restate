...
use crate::metric_definitions::{
    INVOKER_ENQUEUE, INVOKER_INVOCATION_TASKS, INVOKER_SERVICE_DOWN_ERRORS, TASK_OP_COMPLETED,
    ...
    async fn handle_invocation_task_failed(
            ...
            .remove_invocation_with_epoch(partition, &invocation_id, invocation_epoch)
        {
            ...
            if self.is_service_down_error(&error) {
                counter!(INVOKER_SERVICE_DOWN_ERRORS, "service" => ism.invocation_target.service_name().to_string()).increment(1);
            }
