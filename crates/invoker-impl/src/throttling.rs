...
use gardal::{
    AtomicStorage, Clock, RateLimitedStreamExt, TokenBucket, TokioClock, futures::RateLimitedStream,
};
...
pin_project_lite::pin_project! {
    ...
    enum RateLimiterInner<C> where C: Clock {
        ...
        Limited{#[pin] stream:RateLimitedStream<Iter<Repeat<()>>, AtomicStorage, C>},
    }
}
    ...
    C: Clock,
{
    ...
    pub fn limited(bucket: TokenBucket<AtomicStorage, C>) -> Self {
