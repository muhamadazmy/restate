...
use restate_types::journal_v2::{
    CommandIndex, CommandType, Entry, EntryType, NotificationsCombinator, RunCompletion, RunResult,
};
    ...
    Schemas: InvocationTargetResolver,
{
    ...
    fn handle_suspension_message(
        ...
        let combinator: NotificationsCombinator =
            match awaiting_on.try_into().map_err(GenericError::from) {
