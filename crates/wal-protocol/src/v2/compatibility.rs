    ...
    fn try_from(value: v1::Envelope) -> Result<Self, Self::Error> {
        ...
        let envelope = match value.command {
            ...
            v1::Command::AttachInvocation(payload) => {
                records::AttachInvocation::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::InvocationResponse(payload) => {
                records::InvocationResponse::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::Invoke(payload) => {
                records::Invoke::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::InvokerEffect(payload) => {
                records::InvokerEffect::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::NotifyGetInvocationOutputResponse(payload) => {
                records::NotifyGetInvocationOutputResponse::new(source, dedup, payload.into())
                    .into_raw()
            }
            v1::Command::NotifySignal(payload) => {
                records::NotifySignal::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::PatchState(payload) => {
                records::PatchState::new(source, dedup, payload.into()).into_raw()
            }
            ...
            v1::Command::PurgeInvocation(payload) => {
                records::PurgeInvocation::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::PurgeJournal(payload) => {
                records::PurgeJournal::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::RestartAsNewInvocation(payload) => {
                records::RestartAsNewInvocation::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::ResumeInvocation(payload) => {
                records::ResumeInvocation::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::ScheduleTimer(payload) => {
                records::ScheduleTimer::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::TerminateInvocation(payload) => {
                records::TerminateInvocation::new(source, dedup, payload.into()).into_raw()
            }
            v1::Command::Timer(payload) => {
                records::Timer::new(source, dedup, payload.into()).into_raw()
            }
