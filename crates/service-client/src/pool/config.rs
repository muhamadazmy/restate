...
pub struct PoolConfig {
    ...
    /// `max_connections`). 1 disables eager creation. Defaults to 0.7
    #[builder(default = 0.7f64)]
    pub(crate) connection_saturation_threshold: f64,
...
impl Default for PoolConfig {
    fn default() -> Self {
        Self {
            ...
            connection_saturation_threshold: 0.7,
