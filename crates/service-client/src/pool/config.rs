...
pub struct PoolConfig {
    ...
    /// When available H2 stream capacity across all connections drops below
    /// this percentage, proactively open a new connection (if under
    /// `max_connections`). 0 disables eager creation. Defaults to 0.3
    #[builder(default = 0.3f64)]
    pub(crate) eager_connection_threshold_percent: f64,
...
impl Default for PoolConfig {
    fn default() -> Self {
        Self {
            ...
            eager_connection_threshold_percent: 0.3,
