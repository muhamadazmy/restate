...
pub(crate) const RECORDS_ENQUEUED_COUNT: &str = "restate.sequencer.records_enqueued.total";
pub(crate) const RECORDS_COMMITTED_COUNT: &str = "restate.sequencer.records_committed.total";
pub(crate) const RECORDS_ENQUEUED_BYTES: &str = "restate.sequencer.records_enqueued.bytes";
pub(crate) const RECORDS_COMMITTED_BYTES: &str = "restate.sequencer.records_committed.bytes";
pub(crate) const LOG_SERVER_LATENCY: &str = "restate.sequencer.log_server_latency.ms";
