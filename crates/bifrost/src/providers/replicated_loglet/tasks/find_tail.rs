...
use crate::providers::replicated_loglet::loglet::FindTailAttrs;
...
impl<T: TransportConnect> FindTailTask<T> {
    ...
    #[instrument(skip_all)]
    pub async fn run(self, opts: FindTailAttrs) -> FindTailResult {
        // Special case:
        ...
        let get_seq_state = GetSequencerState {
            ...
            force_seal_check: opts == FindTailAttrs::ForceSealCheck,
        };
