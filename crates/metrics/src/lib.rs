...
///
/// ```rust
/// use restate_metrics::{set_metrics_cardinality_level, get_metrics_cardinality_level};
/// use metrics::Level;
///
/// // Set the cardinality level to DEBUG
/// set_metrics_cardinality_level(Level::DEBUG);
/// assert_eq!(get_metrics_cardinality_level(), Level::DEBUG);
///
/// // Set the cardinality level to ERROR
/// set_metrics_cardinality_level(Level::ERROR);
/// assert_eq!(get_metrics_cardinality_level(), Level::ERROR);
/// ```
