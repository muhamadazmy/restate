...
criterion_group!(
    ...
    targets=flexbuffer_node_state_serialization, bilrost_node_state_serialization, flexbuffer_schema_metadata_serialization, bilrost_schema_metadata_serialization
);
