...
super::define_rpc! {
    @request=GetPartitionProcessorsState,
    @response=PartitionProcessorsStateResponse,
    @request_target=TargetName::NodeGetPartitionProcessorsStateRequest,
    @response_target=TargetName::NodeGetPartitionProcessorsStateResponse,
}

#[derive(Debug, Clone, Copy, Default, Serialize, Deserialize)]
pub struct GetPartitionProcessorsState {}

#[serde_as]
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PartitionProcessorsStateResponse {
