...
use crate::dto::DataTransferObject;
...
impl DataTransferObject for Stored {
...
impl DataTransferObject for Released {
    type Target = message::LogServerResponseHeader;
    type Error = ConversionError;
...
impl DataTransferObject for Sealed {
    type Target = message::LogServerResponseHeader;
    type Error = ConversionError;
...
impl DataTransferObject for Trimmed {
    type Target = message::LogServerResponseHeader;
    type Error = ConversionError;
...
impl DataTransferObject for TailUpdated {
    type Target = message::LogServerResponseHeader;
    type Error = ConversionError;
