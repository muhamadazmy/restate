...
macro_rules! define_logserver_rpc {
    (
        ...
        crate::net::default_wire_codec!(ProtocolVersion::V2, $request $(as $as_request)?);
        crate::net::default_wire_codec!(ProtocolVersion::V2, $response $(as $as_response)?);
...
macro_rules! define_logserver_unary {
    (
        ...
        crate::net::default_wire_codec!(ProtocolVersion::V2, $message $(as $as_message)?);
