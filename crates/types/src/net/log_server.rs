...
macro_rules! define_logserver_rpc {
    ...
    (
        ...
        crate::net::define_rpc! {
            @proto = ProtocolVersion::Bilrost,
            @request = $request $(as $request_type)?,
            @response = $response $(as $response_type)?,
            @request_target = $request_target,
            @response_target = $response_target,
        }
...
define_logserver_rpc! {
    @proto = ProtocolVersion::Bilrost,
    @request = Store as message::Store,
    @response = Stored,
...
define_logserver_rpc! {
    ...
    @response = LogletInfo as message::LogletInfo,
...
define_logserver_rpc! {
    @proto = ProtocolVersion::Bilrost,
    @request = GetRecords as message::GetRecords,
    @response = Records as message::Records,
...
define_logserver_rpc! {
    @proto = ProtocolVersion::Bilrost,
    @request = WaitForTail as message::WaitForTail,
...
define_logserver_rpc! {
    @proto = ProtocolVersion::Bilrost,
    @request = GetDigest,
    @response = Digest as message::Digest,
