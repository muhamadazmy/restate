...
//       @message = IngressMessage (as BilrostMessageType)?,
//       @target = TargetName::Ingress,
//  }
// ```
macro_rules! define_message {
    (
        ...
        impl $crate::net::codec::WireDecode for $message {
            ...
            where
                Self: Sized,
            {
                $crate::net::codec::decode_as_flexbuffers(buf, $crate::net::ProtocolVersion::V1)
            }
        }
    };
    ...
    (
        ...
        $(
            impl $crate::dto::IntoDto for $message {
            ...
            impl $crate::dto::FromDto for $message {
                type Target = $message_type;
