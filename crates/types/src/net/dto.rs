...
pub trait IntoBilrostDto {
    type Target: bilrost::Message + NetworkMessage;
...
pub trait FromBilrostDto: Sized {
    type Target: bilrost::OwnedMessage + NetworkMessage;
...
where
    T: bilrost::Message + NetworkMessage,
{
    type Target = T;
...
where
    T: bilrost::OwnedMessage + NetworkMessage,
{
    type Target = T;
