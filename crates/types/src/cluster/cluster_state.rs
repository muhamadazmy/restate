...
#[derive(Debug, Clone, IntoProto)]
#[proto(target = "crate::protobuf::cluster::SchrodingerNode")]
/// As the name implies, SchrodingerNode is both dead and alive
/// until we receive a heartbeat
pub struct SchrodingerNode {
    #[proto(required)]
    pub generational_node_id: GenerationalNodeId,
}
