...
use enum_map::Enum;
use restate_encoding::{BilrostAs, BilrostNewType};
...
#[derive(Debug, Clone, Eq, PartialEq, serde::Serialize, serde::Deserialize, BilrostAs)]
...
#[derive(derive_more::Debug, Clone, serde::Serialize, serde::Deserialize, BilrostAs)]
#[bilrost_as(dto::Logs)]
