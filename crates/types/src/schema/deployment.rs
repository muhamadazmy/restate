...
#[derive(Debug, Copy, Clone, Eq, PartialEq, Serialize, Deserialize, bilrost::Enumeration)]
...
#[derive(Debug, Clone, Default, Serialize, Deserialize, BilrostAs)]
#[cfg_attr(feature = "schemars", derive(schemars::JsonSchema))]
...
#[serde_as]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Default, BilrostAs)]
