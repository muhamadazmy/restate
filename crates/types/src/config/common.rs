...
pub struct CommonOptions {
    ...
    pub default_cluster_configuration: Option<ClusterConfigurationSeed>,
...
///
/// Configure initial cluster configuration.
#[serde_as]
...
pub enum ClusterConfigurationType {
    #[default]
    /// Use sane default cluster configuration mainly
    /// suitable for a single node setup
    Default,
    /// No default cluster configuration. Configuration
    /// then has to be initialized manually by other means
    Empty,
}
