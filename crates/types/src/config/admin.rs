...
use crate::replication::ReplicationPropertyFromNonZeroU8;
...
pub struct AdminOptions {
    ...
    #[cfg_attr(feature = "schemars", schemars(with = "String"))]
    default_partition_replication: Option<ReplicationProperty>,
...
impl<'de> DeserializeAs<'de, PartitionReplication> for PartitionReplicationFromReplicationProperty {
    ...
    {
        serde_with::PickFirst::<(ReplicationPropertyFromNonZeroU8, serde_with::DisplayFromStr)>::deserialize_as(deserializer).map(PartitionReplication::Limit)
    }
}
