...
use crate::protobuf::cluster::{
    ...
    ReplicationStrategy as ProtoReplicationStrategy, ReplicationStrategyFactor,
    ReplicationStrategyOnAllNodes,
};
...
mod test {
    ...
    use crate::{
        ...
        protobuf::cluster::{
            node_set_selection_strategy, replication_strategy,
            NodeSetSelectionStrategyStrictFaultTolerantGreedy, ReplicationStrategyFactor,
        },
    ...
    fn test_cluster_config_from() {
        ...
        assert_that!(
            ...
            some(eq(ProtoReplicationStrategy {
                strategy: Some(replication_strategy::Strategy::Factor(
                    ReplicationStrategyFactor { factor: 10 }
                ))
            }))
        );
