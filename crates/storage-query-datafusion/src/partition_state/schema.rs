...
define_table!(
    ...
    partition_state(
        ...
        /// Node generation
        node_generation: DataType::UInt32,
        ...
        /// Last updated
        updated_at: DataType::UInt64,

        /// Last observed leader epoch
        leader_epoch: DataType::UInt64,

        /// Last observed leader node ID
        leader_node_id: DataType::UInt32,

        /// Last observed leader node generation
        leader_node_generation: DataType::UInt32,

        /// Last applied log LSN
        applied_log_lsn: DataType::UInt64,

        /// Last record applied at
        last_record_applied_at_ts: DataType::UInt64,
